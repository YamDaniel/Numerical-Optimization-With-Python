...
class Minimizer_function:
    ...
    def minimizer(self, f, x0, step_len=None, obj_tol=1e-12, param_tol=1e-8, max_cond=1e+10, hessian=False, wolfe_backtracking=False, title=None):
        f_history = []
        x_history = []
        f.hessian = hessian
        status = False
        ...
        print(f'\nFinal {title} function location is {x_history[-1].T}\nFinal {title} function value is {f_history[-1]}\nStatus is {status}\n')
